...
class Registration {
 public:
	 ...
	 */
	void setVoxelgridSize(double voxelgrid_size) { this->voxelgrid_size = static_cast<float>(voxelgrid_size); }
	/**
	 * @brief Set target pointcloud.
	 * @param target_cloud Target pointcloud
	 */
	void setTarget(pcl::PointCloud<pcl::PointXYZ>::Ptr target_cloud) { this->target_cloud = target_cloud; }
	/**
	 * @brief Set source pointcloud.
	 * @param source_cloud Source pointcloud
	 */
	void setSource(pcl::PointCloud<pcl::PointXYZ>::Ptr source_cloud) { this->source_cloud = source_cloud; }
	void init();
	 ...
	 */
	unsigned getTargetSize() { return target_size; }
	/**
	 * @brief Get source pointcloud size.
	 * @return Source pointcloud size
	 */
	unsigned getSourceSize() { return source_size; }
