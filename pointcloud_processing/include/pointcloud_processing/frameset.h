...
class Frameset {
 public:
	 ...
	 */
	NppStreamContext* getNppContext() { return &npp_context; }
	/**
	 ...
	 */
	Intrinsics getColorIntrinsics() { return color_frame.getIntrinsics(); }
	/**
	 * @brief Get depth frame intrinsics.
	 * @return Depth frame intrinsics
	 */
	Intrinsics getDepthIntrinsics() { return depth_frame.getIntrinsics(); }
	/**
	 * @brief Get color frame intrinsics from gpu device.
	 * @return Color frame intrinsics
	 */
	Intrinsics* getColorDevIntrinsics() { return color_frame.getDevIntrinsics(); }
	/**
	 * @brief Get depth frame intrinsics from gpu device.
	 * @return Depth frame intrinsics
	 */
	Intrinsics* getDepthDevIntrinsics() { return depth_frame.getDevIntrinsics(); }
	/**
	 * @brief Get number of valid pixels.
	 * @return Number of valid pixels
	 */
	unsigned getMaskCount() { return depth_frame.getMaskCount(); }
	/**
