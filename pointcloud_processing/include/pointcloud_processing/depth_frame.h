...
public:
	 ...
	 */
	uint16_t* getUnaligned()
	{
		return dev_depth_unaligned;
	}
	/**
	 ...
	 */
	Intrinsics getIntrinsicsUnaligned()
	{
		return intrinsics_unaligned;
	}
	/**
	 * @brief Get unaligned frame intrinsics on gpu device.
	 * @return Unaligned frame intrinsics device pointer
	 */
	Intrinsics* getDevIntrinsicsUnaligned()
	{
		return dev_intrinsics_unaligned;
	}
	/**
	 ...
	 */
	Extrinsics* getDevExtrinsics()
	{
		return dev_extrinsics;
	}
	/**
	 ...
	 */
	unsigned getPixelCountUnaligned()
	{
		return pixel_count_unaligned;
	}
	/**
