...
public:
	...
	const bool &publish_fps() const
	{
		return m_publish_fps;
	}
	const bool &publish_duration() const
	{
		return m_publish_duration;
	}
	const bool &publish_latency() const
	{
		return m_publish_latency;
	}
	const bool &profiling() const
	{
		return m_profiling;
	}
	const bool &log_to_file() const
	{
		return m_log_to_file;
	}
	const bool &print_statistics() const
	{
		return m_print_statistics;
	}
	const bool &qos() const
	{
		return m_qos;
	}
	const int &log_count_max() const
	{
		return m_log_count_max;
	}
	const bool &simulation() const
	{
		return m_simulation;
	}
	const bool &save_data() const
	{
		return m_save_data;
	}
	...
	const float &depth_scale() const
	{
		return m_depth_scale;
	}
	const std::string &camera_serial_no() const
	{
		return m_camera_serial_no;
	}
	const std::array<int, 4> &roi() const
	{
		return m_roi;
	}
	const bool &enable_rs_debug() const
	{
		return m_enable_rs_debug;
	}
	const bool &qos_sensor_data() const
	{
		return m_qos_sensor_data;
	}
	const int &qos_history_depth() const
	{
		return m_qos_history_depth;
	}
	...
	const std::string &topic_fps() const
	{
		return m_topic_fps;
	}
	const std::string &topic_duration() const
	{
		return m_topic_duration;
	}
	const std::string &topic_latency() const
	{
		return m_topic_latency;
	}
	const std::string &topic_color() const
	{
	...
	{
		return m_topic_depth;
	}
	const std::string &topic_frameset() const
	{
		return m_topic_frameset;
	}
	const std::string &color_image_filename() const
	{
		return m_color_image_filename;
	}
	const std::string &depth_image_filename() const
	{
		return m_depth_image_filename;
	}
	const std::string &color_intrinsics_filename() const
	{
		return m_color_intrinsics_filename;
	}
	const std::string &depth_intrinsics_filename() const
	{
		return m_depth_intrinsics_filename;
	}
	const double &sim_depth_scale() const
	{
		return m_sim_depth_scale;
	}
	const unsigned &simulation_framerate() const
	{
		return m_simulation_framerate;
	}
...
private:
	...
	double m_sim_depth_scale                = 0.00025;
